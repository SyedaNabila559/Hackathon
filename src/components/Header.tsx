      ...
      <div className="bg-white shadow-md border-b-2 border-[#E5E5E5] relative z-40">
          ...
          <nav className="hidden md:flex">
            <ul className="flex gap-8 text-sm font-medium text-[#737373]">
              ...
              <li className="relative group">
                <Link href="/Product_list" className="flex items-center gap-1 hover:text-[#23A6F0] transition-all">
                  Shop
                  <FiChevronDown />
                </Link>
              </li>
        ...
        {isMenuOpen && (
          <div className="md:hidden bg-white shadow-md transition-all duration-300 ease-in-out">
            <ul className="flex flex-col gap-4 p-4 text-lg text-[#737373] text-center">
              <li>
                <Link href="/" className="hover:text-[#23A6F0] transition-all">
                  Home
                </Link>
              ...
              <li>
                <Link href="/Product_list" className="hover:text-[#23A6F0] transition-all">
                  Shop
                </Link>
              </li>
              <li>
